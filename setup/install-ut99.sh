...
# ARGBASH_SET_INDENT([  ])
# ARG_OPTIONAL_SINGLE([destination],[d],[Install directory. Will be created if it doesn't exist.],[${XDG_DATA_HOME:-${HOME}/.local/share}/OldUnreal/UnrealTournament])
...
_arg_destination="${XDG_DATA_HOME:-${HOME}/.local/share}/OldUnreal/UnrealTournament"
_arg_ui_mode="auto"
